...
public class Restaurant
{
    ...
    {
        return "ClassPojo [book_form_web_view_url = "+book_form_web_view_url+", location = "+location+", is_zomato_book_res = "+is_zomato_book_res+", mezzo_provider = "+mezzo_provider+", establishment_types = "+establishment_types+", currency = "+currency+", apikey = "+apikey+", id = "+id+", price_range = "+price_range+", name = "+name+", R = "+R+", events_url = "+events_url+", include_bogo_offers = "+include_bogo_offers+", order_url = "+order_url+", cuisines = "+cuisines+", photos_url = "+photos_url+", has_online_delivery = "+has_online_delivery+", offers = "+offers+", featured_image = "+featured_image+", menu_url = "+menu_url+", is_delivering_now = "+is_delivering_now+", switch_to_order_menu = "+switch_to_order_menu+", url = "+url+", user_rating = "+user_rating+", is_book_form_web_view = "+is_book_form_web_view+", is_table_reservation_supported = "+is_table_reservation_supported+", deeplink = "+deeplink+", order_deeplink = "+order_deeplink+", opentable_support = "+opentable_support+", average_cost_for_two = "+average_cost_for_two+", thumb = "+thumb+", has_table_booking = "+has_table_booking+", book_again_url = "+book_again_url+"]";
    }
}
